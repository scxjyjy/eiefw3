...
void GpioSetup(void)
{
  ...
  NRF_GPIO->PIN_CNF[P0_28_INDEX] = P0_29_LED_RED_CNF;
  NRF_GPIO->PIN_CNF[P0_27_INDEX] = P0_29_LED_RED_CNF;
  NRF_GPIO->PIN_CNF[P0_26_INDEX] = P0_29_LED_RED_CNF;
  NRF_GPIO->PIN_CNF[P0_10_INDEX] = P0_29_LED_RED_CNF;
